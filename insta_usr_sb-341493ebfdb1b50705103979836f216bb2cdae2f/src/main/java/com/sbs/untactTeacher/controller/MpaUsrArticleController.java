...
public class MpaUsrArticleController {
	...
	public String showList(HttpServletRequest req, @RequestParam(defaultValue = "1") int boardId, String searchKeyword,
			String searchKeyWordType, @RequestParam(defaultValue = "1") int page) {
		...
		List<Article> articles = articleService.getForPrintArticles(boardId, searchKeyword, searchKeyWordType,
...
//	@RequestMapping("/mpaUsr/article/doSearch")
//	@ResponseBody
//	public List<Article> doSearch(String searchKeywordType,String searchKeyword) {
...
//			searchKeywordType = null;
//		}
//		return articleService.getSearchArticle(searchKeywordType,searchKeyword);
//	}
